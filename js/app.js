(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main-block__slider")) {
            new swiper_core_Swiper(".slider-main-block__slider", {
        ...
        if (document.querySelector(".slider-controll-main-block__slider")) {
            new swiper_core_Swiper(".slider-controll-main-block__slider", {
                modules: [ Navigation, Autoplay, Scrollbar ],
                direction: "vertical",
                observer: true,
                observeParents: true,
        ...
        if (document.querySelector(".blends__slider")) {
        ...
        if (document.querySelector(".our-gallery__slider")) {
            new swiper_core_Swiper(".our-gallery__slider", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 6,
        ...
        myImageSlider.controller.control = myControlSlider;
        myControlSlider.controller.control = myImageSlider;
    }
...
***************************************************************************** */
    ...
    function documentActions(e) {
        ...
        if (targetElement.closest(".top-footer__button")) {
            window.scrollTo({
                top: 0,
                behavior: "smooth"
            });
